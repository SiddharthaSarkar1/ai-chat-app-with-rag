  ...
  return (
    <div className='pdf-upload-container'>
      ...
      {file && <div>
        ...
        <p>Please click the below button to upload and process the PDF.</p>
      </div>}
      {file && <button onClick={handleUpload} disabled={!file} className="upload-button"><FileUp size={25} /> Upload and Process PDF</button>}
    </div>
  );
}